            ...
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg p-6">
                <form action="{{ route('post.update', $post) }}" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="mt-6">
                        ...
                        <x-textarea id="content" class="block mt-1 w-full min-h-[200px]" name="content" required>
                    ...
                    {{-- Published At --}}
                    <div class="mt-6">
                        <x-input-label for="published_at" :value="__('Scheduled Publication')" />
                        <x-text-input id="published_at" class="block mt-1 w-full" type="datetime-local" name="published_at"
                            :value="old('published_at', $post->published_at?->format('Y-m-d\TH:i'))" />
                        <p class="text-xs text-gray-500 mt-1">Leave blank to publish immediately, or set a future date to schedule.</p>
